...
localparam CMOS_H_PIXEL = 24'd1024;//CMOS水平方向像素个数
localparam CMOS_V_PIXEL = 24'd76; //CMOS垂直方向像素个数
...
begin
	case(lut_index)			  
		...
		10'd302: lut_data <= {8'h78 , 24'h3b0000}; //STROBE CTRL: strobe request OFF 
            //测试闪光灯功能
        10'd303: lut_data <= {8'h78,16'h3016,8'h02};
        10'd304: lut_data <= {8'h78,16'h301c,8'h02};
        10'd305: lut_data <= {8'h78,16'h3019,8'h02}; //打开闪光灯
        10'd306: lut_data <= {8'h78,16'h3019,8'h00}; //关闭闪光灯
        //只读存储器,防止在case中没有列举的情况，之前的寄存器被重复改写
        default : lut_data <= {8'hff,16'hffff,8'hff}; //器件ID高8位
	endcase
end
